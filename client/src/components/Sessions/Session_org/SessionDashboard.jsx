...
const fetchData = async () => {
    ...
    useEffect(() => {
        fetchData();
    }, []); // Re-fetch when location changes (after updates)
  ...
  <br></br>
        ...
        >*/}
          ...
          {noResults ? (
            ...
            <div className="card-image-wrapper"/*style={{ position: "relative", display: "inline-block",width: "100%" }}*/>
  ...
  />
        ...
        <br />
        <input className="card-type-badge" type="file" accept="image/*" onChange={handlePhotoChange}  id="fileInput" style={{ display: "none" }} />
         <label
    htmlFor="fileInput"
    style={{
      position: "absolute",
